...
Firstly, bind the three DE genesets together and convert to a tibble. Then, add a column with GeneNames and a column indicating the directionality of differential expression (up or down). Lastly, filter and arrange rows (genes) based on logFC and adjusted p-values.
