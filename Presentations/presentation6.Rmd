...
```{r}
# First, we count the number of times a count value in a sample is greater or equal to 3. Then Filter rows where at least 3 samples has a count great than 4.
