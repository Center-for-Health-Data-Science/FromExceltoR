...
## Applied Statistics in R - Group Exercise 2


## Structure of a biostatistical analysis in R

When done with this exercise, please write 1-2 sentences about your final conclusion(s) on the association between GeneD expression and psoriasis here (One post per group): https://ucph.padlet.org/tugcekaraderi/ll8rmst6r90xuujq
...
* You will start with your gene of special interest GeneD.
* You decide that your analysis approach will be one-way ANOVA of the expression of the GeneD gene against the skin type in psoriasis patients.
...
# Extract the data of interest containing the GeneD expression levels and skin sample type from the dataset and call this subset psorData
...
QUESTION 2: Please rank the three groups by their mean/average GeneD expression (descending order).
