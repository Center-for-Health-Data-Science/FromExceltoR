...
```{r cars}
stroke <- read.csv("/home/henrike/Documents/Heads_center_management/courses/excel_to_r/June2022/FromExceltoR-June_2022/Exercises/healthcare-dataset-stroke-data.csv")
str(stroke)
```
