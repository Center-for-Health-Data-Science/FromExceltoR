...
b.  Using the graphical interface:
    ...
    Look at lower left of your Rstudio window where you have a window with several tabs. Click on _Packages_. You will see a list of your currently installed packages and their versions. To install `emmeans`, click on _Install_ and start to type the name. You will notice a drop down list appears from which you can select the correct package. This is useful if you are not quite sure of the correct spelling.
