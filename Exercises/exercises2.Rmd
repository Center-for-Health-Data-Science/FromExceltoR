...
1.  You should have already imported the data set from the small exercises during the lecture. If not, import it now. You can also do this via the graphical interface by selecting **Import Dataset** from the **Environment** tab on the upper left window. Check that the data preview looks okay and click _Import_.
