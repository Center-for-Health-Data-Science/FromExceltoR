...
9. Make a PCaA plot for each set using ggplot2. Color the samples by condition and label them by _celltype_ (**airMet** has this information).   
  **HINT** A PCoA plot is just a `geom_point()` plot with x=PCo1 and y=PCo2.
