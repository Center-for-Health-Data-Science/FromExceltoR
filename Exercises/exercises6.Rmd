...
10. If we are to be correct, you should "feed" the function `DESeqDataSetFromMatrix` the normalized counts from the `EDASeq` analysis, where you corrected for GC content and gene Length. This is slightly more tricky, so we have provided you with the code needed for this. Copy and run the code below. 
