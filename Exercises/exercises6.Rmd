...
**Copy and run the code below**. This line of code will give you a new column in your **airDat** tibble named _nzeros_ (Sum of samples where count greater then 3).   
