...
10. Create a new copy of the climate dataset to which you have added a column that states the amount of hours where there was no sunshine for each month. Months have either 720 hours (30 days) or 744 hours (31 days), excluding February, but you can use 730 hours for all months to calculate the new column.
