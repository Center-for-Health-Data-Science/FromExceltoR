...
5.c) all rows from the stations in Oxford and Camborne when there were at least 100 hours of sunlight. Other solutions are possible.  
...
April is month 4 and September is month 9, so we need rows for these months. 
