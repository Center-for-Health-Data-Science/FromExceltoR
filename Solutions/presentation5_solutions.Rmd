...
For questions and comments - please use the padlet here:
...
psoriasisData <- read_excel("~/Documents/GitHub/FromExceltoR/Presentations/psoriasis.xlsx")
...
QUESTION: What is your conclusion from the $F$-test result? Please share your answer here: 
...
QUESTION: What is your conclusion from the pairwise comparisons? Please share your answer here:

IGFL4 gene expression levels are not significantly different between healthy/control skin samples (healthy) and psoriasis-free patient skin samples (psne).
