...
ggplot(resTC, aes(x=geneSymbol, y=log2FoldChange)) + 
  geom_point(aes(color=padj), size=resTC$absLog2FC+2, alpha=0.7) +  
  scale_colour_gradient(high = "#E07400", low ="#003049", na.value = NA) +
  theme_bw() +
  theme(panel.grid.minor = element_blank()) +
  theme(axis.text.x=element_blank(), axis.ticks.x=element_blank()) +
  geom_text(aes(label=geneSymbol), nudge_y = 1.0, size=3, angle = 45) +
