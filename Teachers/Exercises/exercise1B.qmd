...
11. **Loading**. Load the package you just installed with the command `library(ContaminatedMixt)`. If everything went well, you should now able to run the command `data(package = 'ContaminatedMixt')` which will show you an overview of the datasets included in the package.
