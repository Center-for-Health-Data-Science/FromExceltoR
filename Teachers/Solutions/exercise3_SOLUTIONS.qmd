...
36. Use `group_by`, `summarize`, and `facet_wrap` to recreate this plot. Use `group_by`, `summarize`, and `facet_wrap` to recreate this plot. Consider if you need to change the class of some of the variables prior to plotting.
```{r}
